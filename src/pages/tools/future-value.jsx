...
export default function FutureValueTool() {
  return (
    <Layout>
      <SEO
        title="Future Value Calculator — Coming Soon"
        description="Future Value Calculator is currently in development. In the meantime, explore the ten other ready-to-use TopMoneyTools calculators."
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6">
        ...
        <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.3em] text-[#A3FFD6]/60">
          Tool-12 // Future Value Calculator
        </p>
        <h1 className="mt-2 font-heading text-3xl font-bold text-[#E0E0E0] sm:text-4xl">
          In Development
        </h1>
        <p className="mx-auto mt-4 max-w-md text-[#889988]">
          This instrument will project what a dollar today is worth tomorrow, adjusting for inflation, taxes, and opportunity cost. We're calibrating it now — check back shortly.
        </p>
